"""
Django settings for PDF_Filler project.
...
SECRET_KEY = 'django-insecure-f&om+korms^3wf@@3)$(=z%@*9*hjjqy6lwjer9t&8^scom2v^'
...
WSGI_APPLICATION = 'PDF_Filler.wsgi.application'
